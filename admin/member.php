                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        if (isset($_POST['edit'])) {
                            ...
                            $updateQuery = "UPDATE reg_member SET fullname = :fullname, gender = :gender, dept = :dept, admityr = :admityr, session = :session, email = :email, c_number = :c_number WHERE std_id = :std_id";
