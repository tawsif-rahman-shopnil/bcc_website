...
<div class="container-fluid bg-dark topbar">
  <div class="row py-2 px-lg-5 align-items-start">
    <div class="col-lg-6 text-lg-left mb-2 mb-lg-0">
      <div class="d-flex text-white">
        <div class="mr-2"><i class="fa fa-envelope"></i></div>
        <div><small>computerclub@baiust.ac.bd</small></div>
      </div>
    </div>
  </div>
</div>
                ...
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="../csefest.php" class="dropdown-item">CSE Fest 2022</a>
                            <a href="../computenigma.php" class="dropdown-item">Computenigma 2020</a>
                            <a href="../nhpc.php" class="dropdown-item">NHPC 2017</a>
                        </div>
                    </div>
                    <a href="../workshop.php" class="nav-item nav-link">Workshops</a> 
                    <a href="../panel.php" class="nav-item nav-link"> Executive Panels</a>
                    <a href="index.php" class="nav-item nav-link"> CP Ranklist</a>
                </div>
            </div>
        </nav>
    </div>
